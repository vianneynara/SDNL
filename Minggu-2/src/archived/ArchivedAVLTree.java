...
//public class ArchivedAVLTree<T extends Comparable<T>> {
//
//	private AVLNode<T> root;
//	private int size;
//
//	public ArchivedAVLTree() {
//		this.root = null;
//	}
//
//	/**
...
//	 */
//	public ArchivedAVLTree(AVLNode<T> root) {
//		this.root = root;
//	}
//
//	/**
...
//		System.out.println("Rotating right	: " + node + ", L: " + node.left + ", R: " + node.right);
...
//		System.out.println("Rotating left	: " + node + ", L: " + node.left + ", R: " + node.right);
